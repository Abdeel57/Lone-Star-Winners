 ...
 * error de compilacion. Es la primera de las dos redes contra el texto que se
 * queda sin traducir; la segunda es el test de paridad
 * (`src/test/i18n-parity.test.ts`), que ademas compara los dos idiomas entre si.
 *
