 ...
 * Cabecera del sitio.
 *
 * Solo se enlaza lo que EXISTE. `Shop`, `Winners` y la cuenta del participante
 * llegan en hitos posteriores y por eso no aparecen: un enlace a una pantalla
 * que no existe es peor que no tener el enlace, y en un sitio donde una de las
 * rutas son las Reglas Oficiales, un 404 en la barra de navegacion es un
 * problema de confianza, no una molestia.
 *
